...
static const char *fonts[]          = { "SF Pro Text:size=11.5", "fontawesome:size=11.3", "NotoColorEmoji:pixelsize=11.3:antialias=true:autohint=true", "joypixels:size=11.3", "fontello:size=11.3", "font-logos:size=11.3" };
...
static const char col_cyan[]        = "#79b2d4";
static const char col_black[]	    = "#000000";
static const char col_white[]       = "#ffffff";
static const char col_purple[]	    = "#02ffe4";
...
//    { "clipgrab",        NULL,       NULL,   1 << 7,       0,           -1 },
    ...
    { "Nuclear",       NULL,    NULL,	    1 << 0,       0,           -1 },
    { "Rhythmbox",       NULL,  NULL,       1 << 0,       0,           -1 },
    { "KeePassXC",      NULL,   NULL,	    1 << 8,       0,           -1 },
    { "OBS",        NULL,       NULL,       1 << 9,       0,           -1 },
  	{ "ClipGrab",   NULL,       NULL,       1 << 9,       0,           -1 },
    { "Dolphin",    NULL,       NULL,       1 << 3,       0,           -1 },
    { "Tor Browser",    NULL,   NULL,       1 << 5,       0,           -1 },
};
